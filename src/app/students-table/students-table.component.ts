...
@Component({
  ...
  standalone: true,
  imports: [ CommonModule, MatTableModule, MatInputModule, MatFormFieldModule, FormsModule, ReactiveFormsModule ],
...
export class StudentsTableComponent implements OnInit {
    ...
    displayColumns: string[] = ['name', 'city', 'country', 'subjects', 'passportDeclaration', 'fitnessDeclaration', 'courseName', 'date', 'state', 'street', 'email', 'phone', 'postalCode'];
